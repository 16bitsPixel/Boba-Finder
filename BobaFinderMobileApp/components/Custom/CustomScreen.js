  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{
        ...
        <ImageBackground source = {require("../../assets/images/searchbg.png")} resizeMode="cover" style={{ flex: 1 }}>
          <Image
      ...
      <View style={{
        ...
        <Pressable style={{
          ...
          <View style={{
            ...
            <Image source = {require("../../assets/images/basecup.png")}
        ...
        <Pressable style={{
          ...
          <View style={{
            ...
            <Image source = {require("../../assets/images/toppingscup.png")}
